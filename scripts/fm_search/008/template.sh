...
python pragmatic_tuna/scripts/vg_rsa.py --corpus_path data/vg_processed_2_2.dedup.pkl \
    --batch_size 64 \
    --speaker_hidden_dim 754 --listener_learning_rate <llr:L:0.0001,0.01> --speaker_lr_factor <slr:L:1,500> --optimizer sgd \
